...
ROOT_FOLDER_ID = "bd46f529-e1ea-4805-8e93-db92c557e78f"

# Updated to the new Group and Folder URL (ignoring the sorting parameters at the end)
FOLDER_URL = "https://circabc.europa.eu/ui/group/34861680-e799-4d7c-bbad-da83c45da458/library/bd46f529-e1ea-4805-8e93-db92c557e78f"
...
def build_rss():
    ...
    for item in latest_documents:
        ...
        # Updated to the new Group ID and keeps /details appended to the end
        download_link = f"https://circabc.europa.eu/ui/group/34861680-e799-4d7c-bbad-da83c45da458/library/{node_id}/details"
